"""
Django settings for clicktrack project.
...
INSTALLED_APPS = [
    ...
    'clicktrack.apps.common',
    'clicktrack.apps.hello_world'
]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'clicktrack.apps.common.context_processors.gdpr',
            ],
        },
    },
]

WSGI_APPLICATION = 'clicktrack.wsgi.application'
